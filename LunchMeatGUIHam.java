...
public class LunchMeatGUIHam extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LunchMeatGUIHam frame = new LunchMeatGUIHam();
	...
	public LunchMeatGUIHam() {
		...
		JButton btnNewButton_1 = new JButton("Pepper Ham");
		...
		JButton btnNewButton_2 = new JButton("Capicola");
		...
		JButton btnNewButton_3 = new JButton("Bologna");
		...
		JButton btnNewButton_4 = new JButton("Liverwurst");
