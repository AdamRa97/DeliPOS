...
public class VegetableGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VegetableGUI frame = new VegetableGUI();
	...
	public VegetableGUI() {
		...
		JButton btnNewButton = new JButton("Lettuce");
		...
		JButton btnNewButton_1 = new JButton("Tomato");
		...
		JButton btnNewButton_2 = new JButton("Onion");
		...
		JButton btnNewButton_3 = new JButton("Hot peppers");
		btnNewButton_3.setBounds(21, 194, 111, 37);
		contentPane.add(btnNewButton_3);
		
		JButton btnNewButton_4 = new JButton("Sweet peppers");
		btnNewButton_4.setBounds(156, 194, 111, 37);
		contentPane.add(btnNewButton_4);
		
		JButton btnNewButton_5 = new JButton("Pickles");
