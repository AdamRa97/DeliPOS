...
public class LunchMeatGUI3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LunchMeatGUI3 frame = new LunchMeatGUI3();
	...
	public LunchMeatGUI3() {
		...
		JLabel lblNewLabel_1 = new JLabel("Lunch Meat ");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_1.setBounds(110, 61, 74, 26);
		contentPane.add(lblNewLabel_1);
		
		JButton btnNewButton = new JButton("Salami");
		...
		JButton btnNewButton_1 = new JButton("Roast Beef");
		...
		JButton btnNewButton_2 = new JButton("Corned Beef");
		...
		JButton btnNewButton_3 = new JButton("Tuna");
		...
		JButton btnNewButton_4 = new JButton("Chicken Salad");
		btnNewButton_4.setBounds(156, 194, 111, 37);
		contentPane.add(btnNewButton_4);
		
		JButton btnNewButton_5 = new JButton("Geno Samali");
